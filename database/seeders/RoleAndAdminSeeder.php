...
class RoleAndAdminSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissionsData = [
            ...
            ['name' => 'task-types.create', 'description' => 'Crear tipos de tarea',                   'group' => 3],
            ['name' => 'task-types.read',   'description' => 'Ver listado de tipos de tarea',          'group' => 3],
            ['name' => 'task-types.update', 'description' => 'Editar tipos de tarea',                  'group' => 3],
            ['name' => 'task-types.delete', 'description' => 'Eliminar tipos de tarea',                'group' => 3],
            ...
            ['name' => 'tickets.change-type', 'description' => 'Cambiar el tipo de una solicitud', 'group' => 5],
            ['name' => 'tickets.reopen', 'description' => 'Reabrir solicitudes cerradas', 'group' => 5],
        ];
